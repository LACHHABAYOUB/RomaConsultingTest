...
public class OverviewController 
{
	...
	@FXML
	private TableColumn<Achat, Float> PriceColonne;
	...
	private void initialize()
	{
		...
		PriceColonne.setCellValueFactory(cellData -> cellData.getValue().PriceProperty().asObject());
	...
	public void Delete()
	{
		...
		else
		{
			...
			alert.setContentText("Selectionner un champ pour pouvoir Delete");
	...
	private void appuiSurEdit()
	{
		...
		else
		{
	        ...
	        alert.setHeaderText("No purchase is selected");
	        alert.setContentText("Select a purchase.");
